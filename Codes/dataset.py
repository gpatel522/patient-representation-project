...
class DatasetProvider:
  ...
  def read_cuis(self, file_name):
    ...
    #print('cuis file_name-', file_name)
    infile = os.path.join(self.corpus_path, file_name)
  ...
  def make_and_write_token_alphabet(self):
    ...
    print('corpus_path-',self.corpus_path, 'self.use_cuis',self.use_cuis)
    ...
    print('ALPHABET_FILE-', ALPHABET_FILE)
    ...
    print('token2int:', self.token2int)
    # pickle alphabet
  ...
  def map_subjects_to_codes(self,
    ...
    print('done reading ', code_file)

  def make_code_alphabet(self):
    """Map codes to integers"""
    print('make_code_alphabet')
  ...
  def load(self,
    ...
    for file in os.listdir(self.corpus_path):
      ...
      #print('self.subj2codes-', self.subj2codes)
      try:
      ...
      #print('subj2codes[' + str(subj_id) + ']-', self.subj2codes[subj_id])
      #print('code2int-', self.code2int)
